...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>ANTRE LEBIH MUDAH BERSAMA</h1>
            <h2>Itenice Medika</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Sistem Antrian Online RS Itenice</h3>
                            <p>
                                Ini adalah Sistem Antrian Online Rumah Itenice dimana setiap pengunjung dapat
                                mengambil antrian dari rumah
                            </p>
                    ...
                    <div class="col-lg-4">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Jl. Khp Hasan Mustopa No.23</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>itenicemmedika@hospital.com</p>
                            </div>
